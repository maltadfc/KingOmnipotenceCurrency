TEMPLATE = app
TARGET = KingOmnipotenceCurrency
VERSION = 1.0.0.0
...
MOC_DIR = build
UI_DIR = build
RESOURCES = KingOmnipotenceCurrency.qrc
...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.KingOmnipotenceCurrency
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to KingOmnipotenceCurrency.qrc under translations/
...
macx:ICON = src/qt/res/icons/KingOmnipotenceCurrency.icns
macx:TARGET = "KingOmnipotenceCurrency"
