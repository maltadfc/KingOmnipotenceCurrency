...
Value checkkernel(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "KingOmnipotenceCurrencyt connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "KingOmnipotenceCurrencywnloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "KingOmnipotenceCurrencyt connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "KingOmnipotenceCurrencywnloading blocks...");
